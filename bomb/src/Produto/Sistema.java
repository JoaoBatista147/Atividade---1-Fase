...
public class Sistema {
    ...
    public void adicionarProduto(Scanner scanner)
            throws PrecoInvalidoException, CategoriaInvalidaException, CodigoDuplicadoException {
    ...
    private void adicionarEletro(Scanner scanner, String nome, String codigo, double preco)
        ...
        System.out.println("Qual a categoria do eletrodoméstico?");
    ...
    public void buscarProduto(Scanner scanner) throws ProdutoNaoEncontradoException {
